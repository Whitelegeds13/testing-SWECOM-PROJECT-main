    ...
    <div id="my_slider" class="carousel slide" data-ride="carousel">
      <div class="carousel-inner">
        <div class="carousel-item active">
          <div class="row">
            <div class="col-sm-12">
              <h1 class="banner_taital">Comienza ahora! <br>En Loverfit25 encontrarás tu estilo preferido.</h1>
              <div class="buynow_bt"><a href="#">Más información</a></div>
            </div>
          </div>
        </div>
        <div class="carousel-item">
          <div class="row">
            <div class="col-sm-12">
              <h1 class="banner_taital">Tu elijes! <br>Un gran catálogo adecuado para tu estilo.</h1>
              <div class="buynow_bt"><a href="#">Ir ahora</a></div>
            </div>
          </div>
        </div>
        <div class="carousel-item">
          <div class="row">
            <div class="col-sm-12">
              <h1 class="banner_taital">No seas timida! <br>Contactanos para mas información.</h1>
              <div class="buynow_bt"><a href="#">Contáctanos</a></div>
            </div>
          </div>
        </div>
      </div>
